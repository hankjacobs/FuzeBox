...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)gestureRecognizer {
    switch(gestureRecognizer.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            collectionViewCell.layer.shadowRadius = 4.5f;
            collectionViewCell.layer.shadowOpacity = 0.5f;
            collectionViewCell.layer.shadowOffset = CGSizeMake(0.0, 2.5);
            collectionViewCell.layer.shadowColor = [UIColor blackColor].CGColor;
            ...
            [UIView
             ...
             completion:^(BOOL finished) {
                 ...
                 if (strongSelf) {
                     ...
                     collectionViewCell.layer.shadowRadius = 0.0f;
                     collectionViewCell.layer.shadowOpacity = 0.0f;
